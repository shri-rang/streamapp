class AppContent {
  ...
  static final String byTappingContinue =
      "By tapping continue, you agree to Terms and Conditions and Privacy Policy of $appName !";
  ...
  static final String shareAppContent =
      "I would like to share this TV and Movie App . Here you can download this from playstore :";
  ...
  static final String youAreTryingToWatchPaid =
      "You are trying to watch a paid content. \n Please subscribe a plan first.";
  static final String confirmYourDetails = "Confirm your details";
  static final String startStreamingNow =
      "Start Streaming Now - Cancel Anytime";
  static final String bySigingUpYouAgree =
      "By signing up, you agree to our Terms of Use.Your membership automatically renews until cancelled.";
  static final String appNeedsConfiguration =
      'This app needs special configuration to run. Please see [assets/In_App_Purchase_Instruction.txt] for instructions.';
  static final String plan = "Plan:";
  static final String watchPremiumVideo =
      "Watch premium  Video (Subscribe plan bellow)";
  static final String watchAllPremiumMovies =
      "Watch all premium movies and TV shows ";
  ...
  static final String popularStar = "Popular Stars";
  static final String chooseAPlan = "Select a package";
  static final String planIntro =
      "Full access to all free and premium content with download access. Choose a plan based on your usage. Below are the name, price, validity and other info of plans. Please select a plan.";
}
